...
webapp.config(['$routeProvider',
  function($routeProvider) {
    ...
    $routeProvider.when('/tutor/:itemId', {
      templateUrl: 'profile.html',
      controller: 'TutorProfileCtrl',
      viewer: true
    });
    $routeProvider.when('/student/:itemId', {
      templateUrl: 'profile.html',
...
// Left Side
webapp.controller('MainCtrl', ['$scope', 'screenService', 'fontSize',
  function($scope, screenService, fontSize) {
...
webapp.controller('LoginCtrl', ['$scope', '$http', 'Base64',
...
webapp.controller('StudentCtrl', ['$scope', '$http', 'CurrentItem',
  function($scope, $http, CurrentItem) {
    $scope.items = [{
      "_creator": {
        "__v": 0,
...
webapp.controller('TutorCtrl', ['$scope', '$http', 'CurrentItem',
  function($scope, $http, CurrentItem) {
    $scope.items = [];
...
// Right Side
webapp.controller('StudentProfileCtrl', ['$scope', '$http', '$routeParams', 'CurrentItem',
  function($scope, $http, $routeParams, CurrentItem) {
...
webapp.controller('TutorProfileCtrl', ['$scope', '$http', '$routeParams', 'CurrentItem',
  function($scope, $http, $routeParams, CurrentItem) {
...
webapp.controller('UserCtrl', ['$scope', '$http', '$routeParams', 'CurrentItem',
  function($scope, $http, $routeParams, CurrentItem) {
...
// Settings
webapp.controller('SettingsCtrl', ['$scope', 'fontSize',
  function($scope, fontSize) {
